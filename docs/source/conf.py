...
# five_year_plan_analysis documentation build
...
from five_year_plan_analysis import __version__ as release

# -- Project information -----------------------------------------------------

project = "five_year_plan_analysis"
copyright = "2021, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "five_year_plan_analysisdoc"
...
latex_documents = [
    (
        master_doc,
        "five_year_plan_analysis.tex",
        "five_year_plan_analysis Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "five_year_plan_analysis",
        "Project five_year_plan_analysis codebase.",
        "Data-Science",
    )
]
